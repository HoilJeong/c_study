...
/*
 * Name: _30_CheckPoint04
 * DESC: Control, Manager 클래스를 제작하여 시스템 만들기
 */

namespace _30_CheckPoint04
{
    class Army
    {
        protected int _HP;
    ...
    class Healer : Army
    {
        ...
        {
            base.Run();
            Console.WriteLine("Healer 달려갑니다. " + _Speed);
        }
    ...
    class UnitControl
    {
        ...
        public void CreateUnit()
        {
            ...
            if (indexCount >= MAX)
            {
                Console.WriteLine(" == 유닛 생성 불가 == (총 유닛: " + indexCount + ")");
                Console.WriteLine();
            ...
            Console.WriteLine(" == 유닛 생성 완료 == (총 유닛: " + indexCount + ")");
            Console.WriteLine();
        }
        ...
        public void UnitRunMenu()
        {
            ...
            Console.WriteLine("(1)바바리안  (2)자이언트  (3)힐러 (4)전체달리기 (0: 뒤로가기)");
